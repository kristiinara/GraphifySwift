...
class MassiveViewControllerQuery: Query {
    ...
    var classString: String {
        return "match (class:Class) where class.name contains 'ViewController' and class.number_of_methods > \(Metrics.veryHighNumberOfMethods) and class.number_of_attributes > \(Metrics.veryHighNumberOfAttributes) and class.number_of_instructions > \(Metrics.veryHighNumberOfInstructionsClass) return distinct(class.app_key) as app_key, class.name as class_name"
    }
